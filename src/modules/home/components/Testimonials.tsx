		...
		<section className='py-12'>
			<div className='container mx-auto px-4'>
				<div className='flex flex-col-reverse lg:flex-row lg:space-x-4'>
					{/* Text Section */}
					<div className='lg:w-1/3 lg:order-2 md:pt-8 sm:pt-10 xs:pt-12'>
						<p className='mb-2 text-xs text-muted-foreground text-left lg:text-right'>
							{spiels.TESTIMONIALS_LABEL}
						</p>
						<h1 className='font-semibold xs:text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl my-3 text-left lg:text-right'>
