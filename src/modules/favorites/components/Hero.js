...
export default function HeroSection() {
    return (
            <div className="flex items-center justify-center h-screen w-1/2 ">
                ...
                <div className="hidden lg:block fixed w-full px-4 py-8">
            ...
            {/* MOBILE */}
            <div className="flex lg:hidden flex-col items-center justify-center w-full px-4 py-8">
                <p className='my-4 text-pretty text-lg text-white'>Explore Saved Listings</p>
                <h1 className="text-pretty text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#a5b3dc] via-[#a5b3dc] to-[#082e9a]">
                    UniHomes
                </h1>
                <h1 className="text-pretty text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#a5b3dc] via-[#a5b3dc] to-[#082e9a]">
                    Favorite 
                ...
                <form className="flex mt-4 w-full max-w-sm justify-center">
                    <label htmlFor="search" className="sr-only">{spiels.BUTTON_SEARCH}</label>
                    <div className="relative flex w-full">
                        <SearchIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-black" />
                        <input
